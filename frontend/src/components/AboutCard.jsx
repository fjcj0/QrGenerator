...
const AboutCard = ({ icon, title, paragraph }) => {
    return (
        <div className='flex flex-col items-center font-josefinSans justify-center gap-3 p-5 rounded-lg hover:bg-slate-900/80 hover:border-[0.5px] hover:border-white ease transition-colors duration-300'>
