...
const SignUpPage = () => {
    ...
    const isLastNameValid = lastName.length >= 4;
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            await signup(username, email, firstName, lastName, password,confirmPassword);
                        ...
                        <div className='w-full space-y-5 font-josefinSans'>
                            ...
                            <div className='flex items-center justify-center'>
                                <button
                                    ...
                                    className={`border-blue-700 border-[0.2px] px-4 py-2 rounded-lg text-white font-bold font-josefinSans text-xl
        ${!(
                                            isFirstNameValid &&
                                            isLastNameValid &&
                                            isUsernameValid &&
