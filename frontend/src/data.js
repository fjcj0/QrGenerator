...
*/
import smoothSharpShape from './assets/bodyShapes/pstyle.png';
import pstyle from './assets/bodyShapes/pstyle6.png';
...
export const bodyShapes = [
     ...
     */
    { id: 2, src: smoothSharpShape, alt: 'Smooth Sharp', name: 'Smooth Sharp', qrType: 'square' },
    { id: 3, src: pstyle, alt: 'Smooth Sharp', name: 'Smooth Sharp', qrType: 'rounded' },
];
export const eyeFrames = [
    { id: 1, src: circleFrame, alt: 'Circle', name: 'Circle', qrType: 'dot' },
    { id: 2, src: squareFrame, alt: 'Square', name: 'Square', qrType: 'square' },
    /*
    ...
    { id: 5, src: circleFrame, alt: 'Circle', name: 'Circle', qrType: 'dots' },
    */
];
export const eyeBalls = [
    { id: 1, src: circleBall, alt: 'Circle', name: 'Circle', qrType: 'dot' },
    { id: 2, src: squareBall, alt: 'Square', name: 'Square', qrType: 'square' },
    /*
    ...
    { id: 6, src: circleBall, alt: 'Circle', name: 'Circle', qrType: 'dots' },
    */
];
